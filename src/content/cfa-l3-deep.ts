...
export const deepQuestionsL3: Question[] = [
  {
    ...
    choices: ["Strategic long-run asset allocation", "Individual security selection decisions", "Tactical market timing decisions", "Trading execution and implementation"],
    answerIndex: 0,
  ...
  },
  {
    ...
    choices: ["Asset-only allocation", "Goals-based allocation", "Liability-relative allocation", "Tactical asset allocation"],
    answerIndex: 2,
  ...
  },
  {
    ...
    choices: ["Always produces portfolios that are equally weighted", "Ignores expected returns entirely", "Guarantees the highest Sharpe ratio out of sample", "Is highly sensitive to inputs, producing unstable allocations"],
    answerIndex: 3,
...

  {
    ...
    choices: ["Report the bias to regulators", "Charge a higher fee to offset the added work", "Moderate the bias versus adapt the portfolio to it", "Ignore the bias entirely when building the policy"],
    answerIndex: 2,
  ...
  },
  {
    ...
    choices: ["Confirmation bias in evaluating new information", "Anchoring on the original purchase price", "Mental accounting across separate portfolio buckets", "The disposition effect, driven by loss aversion"],
    answerIndex: 3,
  ...
  },
  {
    ...
    stem: "Under prospect theory, an investor sitting on a large paper loss is offered a choice between a certain small further loss and a gamble with the same expected value. The investor most likely:",
    choices: ["Takes the gamble, since investors turn risk-seeking in the loss domain", "Takes the certain loss, since investors are risk-averse in all domains", "Is indifferent, since the two alternatives share an expected value", "Takes the certain loss, since losses weigh more heavily than gains"],
    answerIndex: 0,
    explanation: "Prospect theory's value function is concave over gains and convex over losses, producing risk aversion when ahead and risk SEEKING when behind. Facing a loss, investors commonly gamble to avoid locking it in - the doubling-down behavior seen in the disposition effect. Loss aversion is real and does make losses feel heavier, but it explains the reluctance to realize the loss rather than predicting the choice of the certain option here.",
  },
  {
  ...
  },
  {
    ...
    choices: ["Hindsight bias", "Illusion of control", "Mental accounting", "Availability bias"],
    answerIndex: 2,
  ...
  },
  {
    ...
    choices: ["Confirmation bias", "Anchoring and adjustment", "Self-control bias", "Endowment bias"],
    answerIndex: 3,
...

  {
    ...
    choices: ["Overweight real estate, since volatility appears understated", "Underweight real estate, because volatility is overstated", "Correctly weight real estate within the allocation", "Exclude real estate entirely from the opportunity set"],
    answerIndex: 0,
  ...
  },
  {
    ...
    choices: ["The term premium plus the credit premium", "The liquidity premium plus the credit premium", "The real risk-free rate plus an inflation premium", "The dividend yield plus growth"],
    answerIndex: 2,
  ...
  },
  {
    ...
    choices: ["Using only long-run historical averages of realized returns", "Assuming every market is fully segmented from global capital flows", "Applying the Taylor rule to infer the appropriate policy rate", "Blending fully integrated and fully segmented premiums by degree of integration"],
    answerIndex: 3,
  ...
  },
  {
    ...
    choices: ["An inverted (downward-sloping) curve", "A steeply upward-sloping curve", "A flat curve at high rates", "A curve with high convexity"],
    answerIndex: 0,
  ...
  },
  {
    ...
    choices: ["Below neutral", "Above neutral", "At neutral", "Unrelated to neutral"],
    answerIndex: 1,
...

  {
    ...
    choices: ["Zero", "Twice the liability horizon", "The liability's investment horizon", "The portfolio's convexity"],
    answerIndex: 2,
  ...
  },
  {
    ...
    choices: ["Credit risk from issuer downgrades or default", "Liquidity risk when positions must be unwound", "Currency risk on non-domestic holdings", "Structural risk from non-parallel curve shifts"],
    answerIndex: 3,
  ...
  },
  {
    ...
    choices: ["Funds each liability with matching bond cash flows", "Requires only that portfolio duration match the liability duration", "Takes large active duration bets against the liability benchmark", "Cannot be used to fund a stream of multiple future liabilities"],
    answerIndex: 0,
  ...
  },
  {
    ...
    choices: ["Cash-flow matching against known liabilities", "Contingent immunization", "Riding the yield curve for rolldown return", "Pure indexing of a broad bond benchmark"],
    answerIndex: 2,
  ...
  },
  {
    ...
    choices: ["Shift weight to the short end of the curve", "Move the portfolio entirely into cash equivalents", "Reduce portfolio duration to zero", "Shift weight toward longer maturities or a barbell"],
    answerIndex: 3,
  ...
  },
  {
    ...
    choices: ["A few concentrated bets and lower turnover", "Reliance on individual analyst judgment", "Many small bets across a broad universe, and scalability", "Lower capacity to deploy assets at scale"],
    answerIndex: 2,
  ...
  },
  {
    ...
    choices: ["Low active share and high active risk", "Low active share and low active risk", "Zero active share", "High active share and low active risk"],
    answerIndex: 3,
  ...
  },
  {
    ...
    stem: "A fund holds 4% in cash pending manager transitions but wants full market exposure meanwhile. Buying index futures against that cash accomplishes what?",
    choices: ["Restores market exposure without disturbing the underlying cash position", "Hedges the portfolio's existing equity exposure against a market decline", "Generates additional income from the futures premium over spot", "Reduces overall portfolio risk by adding a diversifying asset class"],
    answerIndex: 0,
    explanation: "Equitizing cash uses long index futures to give the cash balance market exposure, eliminating the performance drag of holding cash in a rising market while the cash itself remains available for the transition. It ADDS market exposure rather than hedging it, and it increases rather than reduces market risk. Futures generate no income - the roll may cost or earn depending on the basis, but that is not the purpose.",
  },
  {
    ...
    choices: ["Maximize market beta exposure", "Strip out market beta to isolate selection skill", "Eliminate all sources of portfolio risk", "Replicate the benchmark index"],
    answerIndex: 1,
...

  {
    ...
    choices: ["Buy 220 contracts", "Short 200 contracts", "Short 220 contracts", "Buy 120 contracts"],
    answerIndex: 2,
  ...
  },
  {
    ...
    choices: ["Buy bond futures", "Enter a receive-fixed swap", "Buy a protective put", "Sell bond futures"],
    answerIndex: 3,
  ...
  },
  {
    ...
    choices: ["Add to the portfolio's duration", "Reduce the portfolio's duration", "Have no effect on duration", "Eliminate credit risk"],
    answerIndex: 0,
  ...
  },
  {
    ...
    choices: ["Premium income in exchange for capped upside", "Downside protection with upside retained, for a premium", "A bounded range of outcomes at zero cost", "Leveraged exposure to the underlying market"],
    answerIndex: 1,
  ...
  },
  {
    ...
    choices: ["Buying a put and buying a call", "Selling a put and selling a call", "Buying a put and selling a call so premiums offset", "Buying two puts at different strike prices"],
    answerIndex: 2,
  ...
  },
  {
    ...
    choices: ["It eliminates all risk from the underlying exposure", "It guarantees a higher return than the cash market", "It removes any requirement to post collateral", "Lower transaction cost while leaving core holdings intact"],
    answerIndex: 3,
  ...
  },
  {
    ...
    choices: ["Bonds generate higher expected returns than the currencies they settle in", "Equity exposures cannot be currency-hedged in practice", "Currency volatility is large relative to bond volatility", "Hedging a bond portfolio can be executed at essentially no cost"],
    answerIndex: 2,
  ...
  },
  {
    ...
    choices: ["Exchange-traded currency option", "Currency swap exchanging principal and interest", "Cross-currency basis swap", "Currency forward, typically rolled at expiry"],
    answerIndex: 3,
  ...
  },
  {
    ...
    choices: ["Protects the downside while retaining part of the upside", "Eliminates all transaction costs", "Guarantees a profit regardless of the currency move", "Removes the need to roll the hedge"],
    answerIndex: 0,
  ...
  },
  {
    ...
    choices: ["Lower transaction costs and deep liquidity", "Higher costs, thinner liquidity, fat tails, and contagion", "No correlation at all with broader global markets", "Permanently fixed exchange rates against the dollar"],
    answerIndex: 1,
...

  {
    ...
    choices: ["A more aggressive personal attitude toward volatility", "Past success in active trading", "Greater wealth relative to needs and a longer time horizon", "A stated preference for high returns"],
    answerIndex: 2,
  ...
  },
  {
    ...
    choices: ["Follow the high willingness, since the client wants risk", "Average willingness and ability, then proceed", "Decline to manage the account", "Base the policy on ability and educate about the conflict"],
    answerIndex: 3,
  ...
  },
  {
    ...
    choices: ["Return objective", "Risk objective", "Liquidity constraint", "Legal constraint"],
    answerIndex: 2,
  ...
  },
  {
    ...
    choices: ["Guarantee the client a stated minimum rate of return", "Replace the need for any formal asset allocation decision", "Eliminate the client's taxes", "Record the client's objectives and constraints to guide decisions"],
    answerIndex: 3,
  ...
  },
  {
    ...
    choices: ["Shorter-duration, more readily liquid holdings", "Longer-duration high-grade bonds matched to the liabilities", "Mostly equities held for long-run growth", "Only cash and equivalents for safety"],
    answerIndex: 1,
  ...
  },
  {
    ...
    choices: ["A mature, retiree-heavy workforce and underfunding", "A weak sponsor highly correlated with plan assets", "A strong sponsor, healthy funding, and a young workforce", "A short horizon over which obligations come due"],
    answerIndex: 2,
  ...
  },
  {
    ...
    stem: "A university endowment holds 55% in private equity, real assets, and hedge funds, with a long horizon and low near-term liquidity needs. This approach relies on:",
    choices: ["Reducing volatility by favoring assets with observable daily pricing", "Maximizing current income to fund the annual spending requirement", "Avoiding equity risk entirely through diversification into alternatives", "Harvesting the illiquidity premium supported by a perpetual horizon"],
    answerIndex: 3,
    explanation: "The endowment model uses a perpetual horizon and modest liquidity needs to capture the return premium available to investors who can tolerate lock-ups. Note the important caveat: infrequent appraisal-based pricing SMOOTHS reported volatility rather than genuinely reducing risk, so the apparent stability is partly an artifact. Alternatives are typically equity-like rather than equity-free, and many produce little current income, which is why spending policy and liquidity planning matter so much here.",
  },
  {
    ...
    choices: ["Provide liquidity and manage balance-sheet interest-rate risk", "Maximize the return on shareholder equity", "Fund an ongoing annual grant-making program", "Pay a stream of defined pension benefits"],
    answerIndex: 0,
  ...
  },
  {
    ...
    stem: "A portfolio manager wants a single measure capturing every cost between the investment decision and the final executed position. Which applies?",
    choices: ["Effective spread, comparing execution price against the quoted midpoint", "Commission per share, the direct explicit cost of executing the order", "Quoted bid-ask spread, the visible cost of immediate execution", "Implementation shortfall, spanning explicit costs and opportunity cost"],
    answerIndex: 3,
    explanation: "Implementation shortfall measures the paper portfolio filled instantly at the decision price against the actual result, capturing commissions, market impact, delay, and the opportunity cost of unfilled shares in one figure. That last component is what distinguishes it: the other three measures all examine trades that actually happened and are blind to the order that got away, which is often the largest cost of all.",
  },
  {
    ...
    choices: ["Opportunity cost", "Market-impact cost", "Commission cost", "Bid–ask spread"],
    answerIndex: 0,
  ...
  },
  {
    ...
    stem: "A manager is evaluated against VWAP and executes a large order over the full trading day. What does this benchmark measure, and what is its weakness?",
    choices: ["Value-weighted average price; it fully captures opportunity cost", "Volume-weighted average price; it can be gamed by timing large orders", "Variance-weighted adjusted price; it accounts for intraday volatility", "Volume-weighted arrival price; it measures cost from the decision point"],
    answerIndex: 1,
    explanation: "VWAP is the volume-weighted average price over the measurement period, and beating it is a common execution mandate. Its weakness is that a patient trader can influence the benchmark itself by participating heavily in the day's volume, and it entirely ignores the cost of orders never filled. Implementation shortfall, measured from the decision price, captures opportunity cost that VWAP cannot see.",
  },
  {
    ...
    choices: ["Patiently with limit orders to minimize market impact", "Only at the closing auction each session", "Aggressively, since alpha decays and opportunity cost is high", "Never, since such trades are prohibited outright"],
    answerIndex: 2,
  ...
  },
  {
    ...
    choices: ["Explicit commissions and taxes on realized gains", "Equity beta exposure and fixed-income duration", "Sharpe and Treynor ratios", "Market impact from trading fast, opportunity cost from trading slow"],
    answerIndex: 3,
...

  {
    ...
    choices: ["Time-weighted return", "Money-weighted return", "Internal rate of return", "Holding-period yield"],
    answerIndex: 0,
  ...
  },
  {
    ...
    choices: ["Sharpe ratio (total risk)", "Standard deviation of returns considered alone", "The money-weighted rate of return over the period", "Treynor ratio or Jensen's alpha, using systematic risk"],
    answerIndex: 3,
  ...
  },
  {
    ...
    stem: "A consultant reviews a proposed benchmark that the manager cannot describe in advance and whose holdings are unknown until period end. Which benchmark property does this violate?",
    choices: ["Specified in advance and unambiguous, with known constituents", "Reflective of the manager's current investment opinions", "Appropriate to the manager's style and investment universe", "Measurable, so that its return can be calculated readily"],
    answerIndex: 0,
    explanation: "A valid benchmark must be specified in advance with identifiable constituents and weights, so that performance is measured against a standard set before the fact rather than one discovered afterward. A benchmark unknown until period end fails this outright and permits retrospective selection of a flattering comparison. The other properties are also required of a valid benchmark, but nothing in the scenario suggests they are breached.",
  },
  {
