...
export const discDeepQuestions: Question[] = [
  ...
  },
  {
    ...
    choices: ["Profitability", "Efficiency", "Liquidity", "Leverage"],
    answerIndex: 3,
  ...
  },
  {
    ...
    choices: ["6,000", "2,250", "3,600", "9,000"],
    answerIndex: 0,
  ...
  },
  {
    ...
    choices: ["6,000", "8,000", "7,000", "9,000"],
    answerIndex: 1,
  ...
  },
  {
    ...
    choices: ["A product cost capitalized in inventory", "Part of direct labor", "A period cost expensed as incurred", "A selling expense only"],
    answerIndex: 2,
  ...
  },
  {
    ...
    choices: ["Quantity (usage) variance", "Efficiency variance", "Volume variance", "Price variance"],
    answerIndex: 3,
  ...
  },
  {
    ...
    choices: ["Shareholders and the managers they hire", "Auditors and regulators", "Customers and suppliers", "Employees and unions"],
    answerIndex: 0,
  ...
  },
  {
    ...
    choices: ["Avoid the activity creating the risk", "Share or transfer the risk to another party", "Reduce the likelihood or impact of the risk", "Accept and retain the risk internally"],
    answerIndex: 1,
  ...
  },
  {
    ...
    choices: ["SOC 2 report", "SOC 3 report", "SOC 1 report", "Comfort letter"],
    answerIndex: 2,
  ...
  },
  {
    ...
    stem: "A ransomware attack encrypts a company's records so staff cannot access them, though the data itself is unaltered and unread. Which element of the CIA triad is primarily compromised?",
    choices: ["Confidentiality, since an unauthorized party accessed the systems", "Integrity, since the encryption has changed the underlying data", "All three equally, since any breach compromises every element", "Availability, since authorized users cannot reach the information"],
    answerIndex: 3,
    explanation: "The CIA triad is confidentiality, integrity, and availability. Encryption that blocks access without exfiltrating or altering the underlying records strikes AVAILABILITY - authorized users cannot obtain the information when needed. Confidentiality would be compromised if the attacker read or exfiltrated the data, and integrity if the data were altered or corrupted. Many real ransomware incidents now involve exfiltration too, but the scenario specifies neither.",
  },
  {
    ...
    choices: ["Positive", "Negative", "Zero", "Equal to the payback period"],
    answerIndex: 0,
  ...
  },
  {
    ...
    choices: ["Payback period equals zero", "Profit is maximized", "NPV equals zero", "WACC is minimized"],
    answerIndex: 2,
  ...
  },
  {
    ...
    choices: ["Is too computationally complex to apply", "Requires the internal rate of return first", "Always rejects good projects", "Ignores time value and cash flows after payback"],
    answerIndex: 3,
