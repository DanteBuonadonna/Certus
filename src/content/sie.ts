    ...
    sections: [
      {
        ...
        blocks: [
          ...
          { kind: "figure", figure: { caption: "Figure 1 — The business cycle. Output rises through an expansion to a peak, falls through a contraction to a trough, then recovers — oscillating around a rising long-run growth trend. Two consecutive quarters of falling real GDP is the classic recession marker.", alt: "A wave of GDP over time labeled with peak, contraction, trough, and recovery, oscillating around a rising dashed trend line.", svg: `<svg viewBox="0 0 460 230" xmlns="http://www.w3.org/2000/svg" width="100%" style="max-width:460px"><line x1="44" y1="174" x2="436" y2="52" stroke="var(--border)" stroke-width="1.3" stroke-dasharray="4 3"/><text x="436" y="48" text-anchor="end" font-size="8.5" fill="var(--text-muted)">long-run growth trend</text><line x1="44" y1="34" x2="44" y2="180" stroke="var(--border)"/><line x1="44" y1="180" x2="436" y2="180" stroke="var(--text-muted)"/><path d="M 44.0 174.0 L 47.3 170.8 L 50.5 167.5 L 53.8 164.3 L 57.1 161.1 L 60.3 158.0 L 63.6 154.9 L 66.9 151.8 L 70.1 148.9 L 73.4 146.0 L 76.7 143.1 L 79.9 140.4 L 83.2 137.8 L 86.5 135.2 L 89.7 132.8 L 93.0 130.5 L 96.3 128.3 L 99.5 126.2 L 102.8 124.3 L 106.1 122.5 L 109.3 120.8 L 112.6 119.3 L 115.9 117.9 L 119.1 116.7 L 122.4 115.6 L 125.7 114.7 L 128.9 113.9 L 132.2 113.2 L 135.5 112.7 L 138.7 112.3 L 142.0 112.1 L 145.3 112.0 L 148.5 112.0 L 151.8 112.2 L 155.1 112.5 L 158.3 112.9 L 161.6 113.4 L 164.9 114.0 L 168.1 114.7 L 171.4 115.5 L 174.7 116.3 L 177.9 117.3 L 181.2 118.3 L 184.5 119.4 L 187.7 120.5 L 191.0 121.6 L 194.3 122.8 L 197.5 124.0 L 200.8 125.2 L 204.1 126.4 L 207.3 127.6 L 210.6 128.8 L 213.9 129.9 L 217.1 131.0 L 220.4 132.1 L 223.7 133.1 L 226.9 134.1 L 230.2 134.9 L 233.5 135.7 L 236.7 136.4 L 240.0 137.0 L 243.3 137.5 L 246.5 137.9 L 249.8 138.2 L 253.1 138.4 L 256.3 138.4 L 259.6 138.3 L 262.9 138.1 L 266.1 137.7 L 269.4 137.2 L 272.7 136.5 L 275.9 135.7 L 279.2 134.8 L 282.5 133.7 L 285.7 132.5 L 289.0 131.1 L 292.3 129.6 L 295.5 127.9 L 298.8 126.1 L 302.1 124.2 L 305.3 122.1 L 308.6 119.9 L 311.9 117.6 L 315.1 115.2 L 318.4 112.6 L 321.7 110.0 L 324.9 107.3 L 328.2 104.4 L 331.5 101.5 L 334.7 98.6 L 338.0 95.5 L 341.3 92.4 L 344.5 89.3 L 347.8 86.1 L 351.1 82.9 L 354.3 79.6 L 357.6 76.4 L 360.9 73.2 L 364.1 69.9 L 367.4 66.7 L 370.7 63.5 L 373.9 60.4 L 377.2 57.3 L 380.5 54.2 L 383.7 51.3 L 387.0 48.4 L 390.3 45.5 L 393.5 42.8 L 396.8 40.2 L 400.1 37.6 L 403.3 35.2 L 406.6 32.9 L 409.9 30.7 L 413.1 28.6 L 416.4 26.7 L 419.7 24.9 L 422.9 23.2 L 426.2 21.7 L 429.5 20.3 L 432.7 19.1 L 436.0 18.0" fill="none" stroke="var(--primary)" stroke-width="2.6"/><circle cx="122.4" cy="115.6" r="3" fill="var(--ats-amber)"/><text x="122.4" y="106.6" text-anchor="middle" font-size="9" font-weight="700" fill="var(--ats-amber)">Peak</text><circle cx="279.2" cy="134.8" r="3" fill="var(--ats-red)"/><text x="279.2" y="150.8" text-anchor="middle" font-size="9" font-weight="700" fill="var(--ats-red)">Trough</text><text x="201" y="195" text-anchor="middle" font-size="8.5" fill="var(--ats-red)">contraction</text><text x="64" y="195" text-anchor="middle" font-size="8.5" fill="var(--ats-green)">expansion</text><text x="326" y="195" text-anchor="middle" font-size="8.5" fill="var(--ats-green)">recovery</text><text x="16" y="107" text-anchor="middle" font-size="9.5" fill="var(--text-muted)" transform="rotate(-90 16 107)">GDP / activity</text><text x="240" y="224" text-anchor="middle" font-size="9.5" fill="var(--text-muted)">time →</text><text x="44" y="22" font-size="11" font-weight="700" fill="var(--text-primary)">The business cycle</text></svg>` } },
        ],
      },
      {
