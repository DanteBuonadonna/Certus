...
const questions: Question[] = [
  // FAR
  {
    ...
    stem: "A company reports total assets of $1,240,000 and total liabilities of $760,000. Stockholders' equity is:",
    choices: ["$480,000, the residual after liabilities are deducted from assets", "$2,000,000, the sum of the assets and liabilities reported", "$760,000, equal to the liabilities the company has outstanding"],
    answerIndex: 0,
    explanation: "The accounting equation states Assets = Liabilities + Equity, so equity is the residual claim: $1,240,000 - $760,000 = $480,000. Equity is what owners would retain after every creditor claim is satisfied, which is why it is called the residual interest. Summing assets and liabilities double-counts the same resources from both sides of the equation, and setting equity equal to liabilities would only hold coincidentally at a 50% debt ratio.",
  },
  {
  ...
  },
  {
    ...
    choices: ["A binding contract is signed by both parties", "Cash is collected from the customer", "Control of the good or service passes to the customer"],
    answerIndex: 2,
  ...
  },
  {
    ...
    choices: ["An unqualified opinion", "An adverse opinion", "A qualified opinion"],
    answerIndex: 1,
    explanation: "When misstatements are both material AND pervasive — so significant that the statements as a whole are misleading — the auditor issues an adverse opinion stating the statements are NOT fairly presented. Choice A (unqualified) is the clean opinion, the opposite. Choice C (qualified) applies when an issue is material but NOT pervasive ('fair except for'); here the pervasiveness pushes it to adverse.",
  },
  {
  ...
  // REG
  {
    ...
    choices: ["Double taxation of corporate profits", "Income is never taxed", "Owners cannot be paid salaries"],
    answerIndex: 0,
    explanation: "A C corporation pays corporate income tax on its profits, and shareholders are taxed again on dividends — 'double taxation.' Pass-through entities (S corps, partnerships, LLCs) avoid this by taxing income once, at the owner level. Choice B is false; C corp income is taxed (twice, in fact). Choice C is incorrect — owners who work in the business can and do receive salaries.",
  },
  {
  ...
  },
  {
    ...
    choices: ["Maximize the client's refund by any means", "Follow the client's instructions without question", "Act with integrity and serve the public interest"],
    answerIndex: 2,
  ...
  },
  {
    ...
    answerIndex: 2,
    explanation: "The COSO framework defines internal control via five components — control environment, risk assessment, control activities, information and communication, and monitoring. Choice A (GAAP) governs financial reporting standards, not internal-control structure. Choice B (the revenue model) is a specific accounting standard for recognizing revenue, unrelated to the internal-control framework.",
  },
  ...
  },
  {
    ...
    choices: ["Lower net income and a lower current tax bill", "Higher net income and higher ending inventory", "No effect on the financial statements"],
    answerIndex: 1,
  ...
  },
  {
    ...
    choices: ["$5,556", "$45,000", "$5,000"],
    answerIndex: 2,
    explanation: "Straight-line depreciation = (cost − salvage) ÷ useful life = ($50,000 − $5,000) ÷ 9 = $45,000 ÷ 9 = $5,000 per year. Choice A wrongly divides the full $50,000 by 9 (ignoring salvage). Choice B ($45,000) is the total depreciable base, not the annual amount.",
  },
  {
    ...
    choices: ["A discount (below par)", "A premium (above par)", "Par value"],
    answerIndex: 0,
    explanation: "When a bond's coupon (4%) is below the market rate (6%), investors will only buy it for less than face value, so it is issued at a discount. Choice B (premium) happens when the coupon exceeds the market rate. Choice C (par) occurs only when the coupon equals the market rate.",
  },
  ...
  // ---- Auditing (AUD) ----
  {
    ...
    choices: ["Reduce the extent of substantive testing", "Lower detection risk with more substantive testing", "Automatically issue a disclaimer of opinion"],
    answerIndex: 1,
  ...
  },
  {
    ...
    choices: ["The external auditor", "The PCAOB", "Management"],
    answerIndex: 2,
    explanation: "Management is responsible for preparing the financial statements and for designing and maintaining internal control; the auditor's role is to express an independent opinion on those statements. Choice A confuses the two roles. Choice B (PCAOB) oversees the audits of public companies — it doesn't prepare any company's statements.",
  },
  {
    ...
    choices: ["A confirmation received directly from an independent third party", "A photocopy of a document provided by management", "Oral inquiry of the client’s own employees"],
    answerIndex: 0,
    explanation: "Evidence obtained directly from a knowledgeable, independent external source (such as a bank or customer confirmation sent straight to the auditor) is among the most reliable. Choice B is internal and easily altered. Choice C (inquiry) is useful but weak on its own and must be corroborated, since it comes from the client.",
  },
  {
    id: "cpa-aud-q7", examSlug: "cpa", topicId: "aud", topicName: "Auditing", difficulty: 2,
    stem: "An auditor discovers a $40,000 error in a company with $8 million of pretax income. Judging materiality, the auditor should consider that a misstatement is material if:",
    choices: ["It exceeds a fixed percentage threshold set by the standards", "It could reasonably influence a user's economic decisions", "It results from intentional rather than inadvertent action"],
    answerIndex: 1,
    explanation: "Materiality turns on whether the misstatement could reasonably be expected to influence the decisions of financial statement users. The standards deliberately set no fixed percentage, because judgment must account for qualitative factors: an immaterial-looking amount can be material if it converts a loss to a profit, meets an analyst forecast, or conceals an illegal act. Intent matters for characterizing FRAUD but does not determine materiality.",
  },
  ...
  // ---- Taxation & Regulation (REG) ----
  {
    ...
    choices: ["More than 30 days", "More than five years", "More than one year"],
    answerIndex: 2,
    explanation: "A capital asset held for more than one year produces a long-term capital gain, taxed at preferential rates; a holding of one year or less is short-term, taxed at ordinary rates. Choice A (30 days) relates to wash sales, not the holding period. Choice B overstates the requirement for the general long-term rate.",
  },
  {
    ...
    choices: ["Have at most 100 eligible shareholders and one stock class", "Be publicly traded on a major exchange", "Have at least one corporate shareholder"],
    answerIndex: 0,
  ...
  },
  {
    ...
    choices: ["$10,000, the donor’s carryover basis", "$60,000, stepped up to fair value at death", "$0, with no basis carried over at all"],
    answerIndex: 1,
  ...
  },
  {
    ...
    choices: ["10 years from filing", "There is no limit", "3 years from filing"],
    answerIndex: 2,
  ...
  },
  {
    ...
    answerIndex: 0,
    explanation: "Section 404(a) requires management's annual assessment of internal control over financial reporting, and 404(b) requires the external auditor to attest to it - though smaller reporting companies and non-accelerated filers are exempt from the attestation. Section 302 covers the CEO and CFO certifications of the statements and disclosure controls, and Section 906 attaches criminal penalties to knowingly false certifications.",
  },

  // ---- Financial Reporting (more) ----
  {
    id: "cpa-far-q8", examSlug: "cpa", topicId: "far", topicName: "Financial Reporting", difficulty: 2,
    stem: "A company pays $24,000 in January for a full year of insurance coverage. The matching principle requires that:",
    choices: ["$24,000 be expensed in January when the cash was paid", "$2,000 be expensed monthly as the coverage is consumed", "The expense be recognized when the policy period finally ends"],
    answerIndex: 1,
    explanation: "The matching principle recognizes expenses in the period in which they help generate revenue, so a prepaid annual policy is capitalized and expensed at $2,000 per month as coverage is used. Expensing the full amount on payment is cash-basis accounting, which distorts January and overstates the following eleven months. Deferring all recognition to expiry would understate expense throughout the year the coverage actually protected operations.",
  },
  {
    ...
    choices: ["One month from the balance sheet date", "Five years from the balance sheet date", "One year or the operating cycle, whichever is longer"],
    answerIndex: 2,
  ...
  // ---- Auditing (more) ----
  {
    ...
    choices: ["Observation of the process being performed", "External confirmation from a third party", "Recalculation of the client’s computations"],
    answerIndex: 1,
    explanation: "Obtaining a direct response from a third party (the customer) about a balance is an external confirmation — strong evidence for existence and accuracy of receivables. Choice A (observation) is watching a process. Choice C (recalculation) is checking the mathematical accuracy of documents.",
  },
  {
  ...
  },
  {
    ...
    stem: "A partner's spouse holds shares in an audit client. Regarding independence, the auditor must be:",
    choices: ["Independent in both fact and appearance, covering close family holdings", "Independent in fact, since appearance concerns are not enforceable", "Independent only during fieldwork, with prior holdings disregarded"],
    answerIndex: 0,
    explanation: "Independence must exist in fact - actual objectivity - and in appearance, meaning a reasonable informed third party would not doubt it. The appearance standard is why a covered member's immediate family holdings impair independence even when the partner's own judgment is genuinely unaffected. Independence is required throughout the professional engagement period and the period covered by the statements, not merely during fieldwork.",
  },

  // ---- Taxation & Regulation (more) ----
  {
    id: "cpa-reg-q8", examSlug: "cpa", topicId: "reg", topicName: "Taxation & Regulation", difficulty: 2,
    stem: "A partnership earns $400,000 of income. How is federal income tax on that income handled?",
    choices: ["The partnership pays entity-level tax and distributions are tax-free", "The partnership files Form 1065 and partners are taxed on their shares", "The partnership pays entity-level tax and partners are taxed again"],
    answerIndex: 1,
    explanation: "A partnership is a pass-through entity: it files Form 1065 as an information return and issues each partner a Schedule K-1, but pays no federal income tax itself. Partners report their distributive shares and pay tax whether or not cash was distributed - a point that surprises partners in a year the partnership reinvests earnings. Entity-level tax followed by shareholder tax describes the C corporation's double taxation.",
  },
  {
    id: "cpa-reg-q9", examSlug: "cpa", topicId: "reg", topicName: "Taxation & Regulation", difficulty: 1,
    stem: "A single taxpayer's itemized deductions total $13,200 while the standard deduction is $14,600. The taxpayer should claim:",
    choices: ["The itemized deductions, since documented expenses take precedence", "Both, since the standard deduction supplements itemized amounts", "The standard deduction, since it exceeds the itemized total"],
    answerIndex: 2,
    explanation: "A taxpayer claims the GREATER of the standard deduction or total itemized deductions, so the $14,600 standard deduction wins here by $1,400. The two are mutually exclusive - they cannot be combined, which is the point of the choice. Documented expenses carry no precedence; the rule is purely which figure is larger, though note that married taxpayers filing separately must both choose the same method.",
  },
  {
    ...
    choices: ["Have a reasonable basis for positions and exercise due care", "Take any position that lowers tax, regardless of support", "Sign returns without review to save time"],
    answerIndex: 0,
    explanation: "A CPA must have adequate support (a reasonable basis or higher, depending on disclosure) for return positions and exercise due professional care and competence. Choice B invites preparer penalties and ethics violations. Choice C breaches due care and the duty to review.",
  },
  ...
  },
  {
    ...
    answerIndex: 0,
    explanation: "The audit committee — composed of independent directors — oversees financial reporting integrity and the relationship with the external auditor, strengthening governance. Choice B is management's job, not the board committee's. Choice C is an operating decision unrelated to the audit committee.",
  },

  // ---- Individual Taxation ----
  {
    id: "cpa-ti-q1", examSlug: "cpa", topicId: "tax-individual", topicName: "Individual Taxation", difficulty: 2,
    stem: "A taxpayer has $95,000 of wages, $3,000 of deductible student loan interest, and $12,000 of itemized deductions. Adjusted gross income is:",
    choices: ["$83,000, wages less both the interest and the itemized deductions", "$92,000, wages less the above-the-line student loan interest", "$95,000, since deductions do not affect adjusted gross income"],
    answerIndex: 1,
    explanation: "AGI is gross income less above-the-line adjustments: $95,000 - $3,000 = $92,000. Student loan interest is an adjustment taken before AGI. Itemized deductions are BELOW-the-line and reduce taxable income rather than AGI - a distinction that matters because numerous phase-outs and thresholds key off AGI, so an above-the-line deduction can be worth more than the same dollar taken below the line.",
  },
  {
    ...
    choices: ["Worth less than the equivalent deduction", "Equal in value to the deduction claimed", "Worth more, reducing tax dollar for dollar"],
    answerIndex: 2,
  ...
  },
  {
    ...
    choices: ["Can reduce the tax liability only to zero", "Can produce a refund beyond the tax owed", "Reduces taxable income, not tax"],
    answerIndex: 1,
  ...
  },
  {
    ...
    choices: ["Never pay more than their regular computed tax", "Are exempt whenever they itemize deductions", "Pay a minimum amount after adding back preference items"],
    answerIndex: 2,
    explanation: "The AMT is a parallel computation that adds back certain preferences/deductions; the taxpayer pays the HIGHER of regular tax or AMT, guaranteeing a minimum. Choice A is backwards. Choice B is false; itemizing doesn't exempt one from AMT.",
  },

  // ---- Cost & Managerial Accounting ----
  {
    id: "cpa-mg-q1", examSlug: "cpa", topicId: "managerial", topicName: "Cost & Managerial Accounting", difficulty: 2,
    stem: "A product sells for $50, has variable costs of $30 per unit, and the company incurs $120,000 of fixed costs. How many units must be sold to break even?",
    choices: ["6,000 units, dividing fixed costs by the $20 contribution margin", "2,400 units, dividing fixed costs by the $50 selling price", "4,000 units, dividing fixed costs by the $30 variable cost"],
    answerIndex: 0,
    explanation: "Contribution margin per unit = selling price − variable cost per unit; it covers fixed costs and then profit. Choice B wrongly subtracts fixed cost per unit. Choice C subtracts total cost, which isn't the contribution-margin definition.",
  },
  {
  ...
  },
  {
    ...
    choices: ["Lower than income under variable costing", "Identical to income under variable costing", "Higher, since fixed overhead is deferred in inventory"],
    answerIndex: 2,
    explanation: "Under absorption costing, fixed overhead attaches to units, so producing more than you sell defers some fixed cost in ending inventory, raising income versus variable costing. Choice A reverses it. Choice B ignores the timing difference that only disappears when production equals sales.",
  },
  {
    id: "cpa-mg-q4", examSlug: "cpa", topicId: "managerial", topicName: "Cost & Managerial Accounting", difficulty: 2,
    stem: "A company sells 12,000 units at a $18 contribution margin against $144,000 of fixed costs. Its margin of safety is:",
    choices: ["4,000 units, or 33% of current sales above breakeven", "8,000 units, the sales volume required to break even", "12,000 units, the full current sales volume achieved"],
    answerIndex: 0,
    explanation: "Breakeven volume is fixed costs divided by contribution margin per unit: $144,000 / $18 = 8,000 units. The margin of safety is how far current sales exceed that point: 12,000 - 8,000 = 4,000 units, or 33% of current sales. It measures the cushion before losses begin. The 8,000 figure is the breakeven point itself rather than the cushion above it, and the full 12,000 assumes a breakeven of zero.",
  },
  {
  ...
  // ---- Liabilities, Bonds & Leases ----
  {
    ...
    choices: ["A premium", "Par", "A discount"],
    answerIndex: 2,
    explanation: "When the stated rate (5%) is below the market rate (7%), investors pay less than face, so the bond is issued at a discount. Choice A (premium) occurs when stated exceeds market. Choice B (par) only when the rates are equal.",
  },
  {
    ...
    choices: ["Carrying value times the effective market rate", "Face value times the stated coupon rate", "Carrying value × stated rate"],
    answerIndex: 0,
    explanation: "Effective-interest expense = carrying value × market rate; the cash paid is face × stated rate, and the difference amortizes the premium or discount. Choice B is the cash interest paid, not the expense. Choice C mixes the wrong rate with carrying value.",
  },
  {
    ...
    choices: ["Kept entirely off of the balance sheet", "Recorded as a right-of-use asset and lease liability", "Treated as an immediate expense of the full lease"],
    answerIndex: 1,
  ...
  },
  {
    ...
    choices: ["Remote in likelihood of occurring", "Reasonably possible but not probable", "Probable and also reasonably estimable"],
    answerIndex: 2,
  ...
  },
  {
    ...
    choices: ["Book income is recognized before taxable income", "A permanent difference exists between book and tax", "Book and tax income are always identical"],
    answerIndex: 0,
  ...
  // Governmental & Nonprofit
  {
    ...
    stem: "A city recognizes property tax revenue only when it is measurable and available within 60 days of year end. This reflects which basis of accounting, and which fund type?",
    choices: ["Full accrual, used by governmental funds like any commercial entity", "Modified accrual, used by governmental funds measuring current resources", "Cash basis, since revenue depends on the timing of collection"],
    answerIndex: 1,
    explanation: "Governmental funds use modified accrual with a current financial resources measurement focus: revenue is recognized when measurable AND available, meaning collectible soon enough to pay current-period liabilities. Proprietary funds and the government-wide statements use full accrual with an economic resources focus. The availability criterion is a modification of accrual accounting, not a cash basis - the revenue is accrued, just subject to a collection window.",
  },
  {
    ...
    choices: ["Earned", "Collected in cash", "Available"],
    answerIndex: 2,
  ...
  },
  {
    ...
    choices: ["Immediately when the promise is made", "Only when cash is received", "When the condition is substantially met"],
    answerIndex: 2,
  ...
  // Revenue Recognition & Leases
  {
    ...
    stem: "A software company signs a contract to deliver a license today and provide support over three years. Under ASC 606, revenue is recognized:",
    choices: ["As each performance obligation is satisfied and control transfers", "Entirely on signing, since the contract price is then determinable", "Entirely on cash collection, when the customer's payment clears"],
    answerIndex: 0,
    explanation: "ASC 606 allocates the transaction price across distinct performance obligations and recognizes revenue as each is satisfied - here the license on delivery and the support ratably over three years. Control transferring to the customer is the trigger. Recognizing everything at signing ignores the undelivered support obligation, and tying recognition to cash collection is the cash-basis approach that accrual accounting exists to replace.",
  },
  {
  ...
  },
  {
    ...
    choices: ["A contract asset recognized on the balance sheet", "Revenue recognized immediately in income", "A contract liability, or deferred revenue"],
    answerIndex: 2,
  ...
  },
  {
    ...
    choices: ["A right-of-use asset and lease liability", "Nothing at all until payments are made", "Only a disclosure within the footnotes"],
    answerIndex: 0,
  ...
  // Audit Reports & Opinions
  {
    ...
    choices: ["Unmodified", "Disclaimer", "Qualified"],
    answerIndex: 2,
  ...
  },
  {
    ...
    choices: ["Adverse opinion", "Qualified opinion", "Emphasis-of-matter paragraph"],
    answerIndex: 0,
  ...
  },
  {
    ...
    choices: ["Modifies the auditor’s opinion to qualified", "Is used only where fraud has been identified", "Highlights a properly disclosed matter without modifying the opinion"],
    answerIndex: 2,
  ...
  },
  {
    ...
    choices: ["An unmodified opinion with a going-concern note", "An adverse opinion on the statements", "A disclaimer of opinion entirely"],
    answerIndex: 0,
  ...
  // Business Law
  {
    ...
    choices: ["Offer, delivery, and notarization", "Offer, acceptance, and consideration", "Writing, witness, and seal"],
    answerIndex: 1,
  ...
  },
  {
    ...
    choices: ["A $200 sale of goods", "A one-week service agreement", "A contract for the sale of land"],
    answerIndex: 2,
  ...
  },
  {
    ...
    choices: ["A third party reasonably believed authority existed", "Apparent authority is irrelevant to the principal", "Agents can never bind a principal to a contract"],
    answerIndex: 0,
    explanation: "Apparent authority binds the principal when a third party reasonably believes, based on the principal's conduct, that the agent is authorized — even absent actual authority. Choice B is false (apparent authority binds the principal), and choice C is false (agents routinely bind principals within actual or apparent authority).",
  },
  {
    ...
    choices: ["Warranty of title only", "Warranty of merchantability", "No warranties at all"],
    answerIndex: 1,
  ...
  },
  {
    ...
    choices: ["A good bargain for one side", "Performance by both parties", "Fraud in the inducement"],
    answerIndex: 2,
  ...
  // Entity Taxation
  {
    ...
    choices: ["Corporate income, then again on shareholder dividends", "Two different states taxing the same income", "Both income and payroll taxes on the same wages"],
    answerIndex: 0,
  ...
  },
  {
    ...
    stem: "A partner receives no cash distribution but the partnership allocates $60,000 of income to them. The partner's tax consequence is:",
    choices: ["No tax is owed until cash is actually distributed to the partner", "Tax is owed only on the portion representing guaranteed payments", "Tax is owed on the $60,000 allocated, regardless of distributions"],
    answerIndex: 2,
    explanation: "Partners are taxed on their DISTRIBUTIVE SHARE of partnership income reported on Schedule K-1, whether or not any cash is distributed. This is the phantom income problem: a partner can owe tax on earnings the partnership retained and reinvested. The allocation increases the partner's basis, so a later distribution of those earnings is not taxed again. Guaranteed payments are additionally treated as ordinary income to the partner.",
  },
  {
    ...
    choices: ["At most 100 eligible shareholders, one stock class", "At least one corporate entity as a shareholder", "Multiple distinct classes of stock outstanding"],
    answerIndex: 0,
  ...
  },
  {
    ...
    choices: ["Their direct cash contributions", "The entity's general third-party debt", "Pass-through income allocated to them"],
    answerIndex: 1,
  ...
  },
  {
    ...
    choices: ["Authorization, recordkeeping, and asset custody", "Sales, marketing, and shipping", "Hiring, training, and payroll"],
    answerIndex: 0,
  ...
  },
  {
    ...
    choices: ["Excessively burdensome documentation requirements", "An excessive number of employees in the process", "Inherent limits such as human error and override"],
    answerIndex: 2,
  ...
  },
  {
    ...
    choices: ["IT general controls (ITGCs)", "Application controls", "Substantive procedures"],
    answerIndex: 0,
