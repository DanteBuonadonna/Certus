...
export const farDeepQuestions: Question[] = [
  {
    ...
    choices: ["Relevance and faithful representation", "Comparability and timeliness", "Verifiability and understandability", "Materiality and consistency"],
    answerIndex: 0,
  ...
  },
  {
    ...
    choices: ["Cash is received from the customer", "It is earned, whenever cash is received", "The invoice is mailed to the customer", "The accounting period is formally closed"],
    answerIndex: 1,
  ...
  },
  {
    ...
    choices: ["Dr Cash 4,000 / Cr Interest Revenue 4,000", "Dr Interest Revenue 4,000 / Cr Interest Receivable 4,000", "Dr Interest Receivable 4,000 / Cr Interest Revenue 4,000", "No entry until cash is received"],
    answerIndex: 2,
  ...
  },
  {
    ...
    choices: ["$50,000", "$44,000", "$66,000", "$56,000"],
    answerIndex: 3,
  ...
  },
  {
    ...
    choices: ["Financing activity", "Operating activity", "Investing activity", "Non-cash activity"],
    answerIndex: 0,
  ...
  },
  {
    ...
    stem: "A company acquires equipment for $80,000, paying $30,000 cash and signing a note for the balance. Immediately after the entry, the accounting equation:",
    choices: ["Balances, since assets rise $80,000 and liabilities rise $80,000", "Balances, since assets rise $50,000 net and liabilities rise $50,000", "Is out of balance until the note is repaid in a later period", "Balances only after equity is adjusted for the cash outflow"],
    answerIndex: 1,
    explanation: "Track both sides. Assets increase by the $80,000 equipment but decrease by the $30,000 cash paid, a net asset increase of $50,000. Liabilities increase by the $50,000 note. The equation holds. Recording an $80,000 liability ignores the cash portion of the payment, and equity is untouched because no revenue, expense, or owner transaction occurred - purchasing an asset with cash and debt never affects equity.",
  },

  {
    ...
    choices: ["Recognize, allocate, price, obligations, contract", "Price, contract, recognize, allocate, obligations", "Contract, obligations, price, allocate, recognize", "Contract, price, recognize, obligations, allocate"],
    answerIndex: 2,
  ...
  },
  {
    ...
    choices: ["The present value of the lease payments", "The total of all undiscounted lease payments", "The fair value of the asset", "Zero — operating leases are off balance sheet"],
    answerIndex: 0,
  ...
  },
  {
    ...
    choices: ["The lease term is a minor part of the asset's life", "Payment present value equals nearly all fair value", "The lease contains no purchase option", "The asset has many alternative uses"],
    answerIndex: 1,
  ...
  },
  {
    ...
    choices: ["Straight-line (even each period)", "Back-loaded (higher in later years)", "Front-loaded (higher in early years)", "Recognized only at lease end"],
    answerIndex: 2,
  ...
  },
  {
    ...
    choices: ["Cash is collected in installments", "The contract spans more than one year", "Management elects to defer the recognition", "The customer consumes benefits as work occurs"],
    answerIndex: 3,
...

  {
    ...
    choices: ["Below the market rate", "Above the market rate", "Equal to the market rate", "Zero"],
    answerIndex: 0,
  ...
  },
  {
    ...
    choices: ["Deferred tax asset", "Permanent difference", "Deferred tax liability", "Valuation allowance"],
    answerIndex: 2,
  ...
  },
  {
    ...
    choices: ["Warranty expense accrual", "Unearned revenue", "Accelerated tax depreciation", "Municipal bond interest"],
    answerIndex: 3,
  ...
  },
  {
    ...
    choices: ["Probable and reasonably estimable", "Reasonably possible and estimable", "Remote but estimable", "Disclosed by the auditor"],
    answerIndex: 0,
...

  {
    ...
    stem: "A government's fund financial statements and its government-wide statements report different results for the same transactions. This is because:",
    choices: ["Government-wide statements exclude all governmental fund activity entirely", "Fund statements are unaudited while government-wide statements are audited", "Governmental funds use modified accrual while government-wide uses full accrual", "Fund statements use the cash basis while government-wide uses accrual"],
    answerIndex: 2,
    explanation: "The two presentations use different measurement focuses and bases. Governmental FUND statements use a current financial resources focus with modified accrual, so capital outlays appear as expenditures and long-term debt is not reported as a fund liability. GOVERNMENT-WIDE statements use an economic resources focus with full accrual, capitalizing assets and recognizing long-term obligations. A reconciliation between them is required precisely because of this difference.",
  },
  {
    ...
    choices: ["At any point in the indefinite future", "Only once the cash is physically in hand", "Within five years of the fiscal year-end", "Within the period or soon after to pay liabilities"],
    answerIndex: 3,
  ...
  },
  {
    ...
    choices: ["Full accrual, like a business", "Modified accrual, like governmental funds", "Cash basis", "No formal accounting"],
    answerIndex: 0,
  ...
  },
  {
    ...
    choices: ["One single combined net asset class", "Two, with and without donor restrictions", "Three distinct net asset classes", "Four separate net asset classes"],
    answerIndex: 1,
  ...
  },
  {
    ...
    choices: ["A liability until spent", "Revenue without donor restrictions immediately", "Revenue increasing net assets WITH donor restrictions", "Not recognized until the clinic is finished"],
    answerIndex: 2,
  ...
  },
  {
    ...
    choices: ["The modified accrual measurement basis", "Budgetary basis only", "The pure cash basis of accounting", "Full accrual, economic-resources measurement"],
    answerIndex: 3,
...

  {
    ...
    choices: ["Their fair values at the acquisition date", "Their existing book carrying values", "The acquirer's historical purchase cost", "Historical cost less depreciation"],
    answerIndex: 0,
  ...
  },
  {
    ...
    choices: ["$0", "$125,000", "$100,000", "$225,000"],
    answerIndex: 1,
  ...
  },
  {
    ...
    choices: ["Fair value method", "Full consolidation", "Equity method", "Cost method with no adjustments"],
    answerIndex: 2,
  ...
  },
  {
    ...
    stem: "Three years after an acquisition, a company reviews the goodwill recorded. Under U.S. GAAP, that goodwill is:",
    choices: ["Amortized on a straight-line basis over a useful life not exceeding forty years", "Written off immediately against equity in the year of acquisition", "Revalued upward when the acquired business outperforms projections", "Tested for impairment at least annually and written down if impaired"],
    answerIndex: 3,
    explanation: "Goodwill is not amortized under U.S. GAAP. It is tested for impairment at least annually at the reporting-unit level, and any write-down is permanent - it cannot be reversed even if the business recovers. Amortization over a stated life was the pre-2001 rule and remains a common distractor, though private companies may elect an amortization alternative. Internally generated goodwill is never recognized, which is why upward revaluation is not permitted.",
  },
  {
    ...
    choices: ["Eliminated", "Reported as consolidated revenue", "Recorded as noncontrolling interest", "Added to goodwill"],
    answerIndex: 0,
  ...
  },
  {
    ...
    choices: ["70% of the subsidiary's assets and income", "All subsidiary assets and income, NCI separate", "Only the dividends actually received", "Only the equity investment account balance"],
    answerIndex: 1,
...

  {
    ...
    choices: ["Higher ending inventory and higher net income", "Lower cost of goods sold and higher net income", "Higher cost of goods sold and lower net income", "Identical results"],
    answerIndex: 2,
  ...
  },
  {
    ...
    choices: ["$1,000", "$1,100", "$2,200", "$1,200"],
    answerIndex: 3,
  ...
  },
  {
    ...
    choices: ["Its fair value is below carrying value", "The asset has been fully depreciated", "Undiscounted cash flows fall below carrying value", "Prevailing market interest rates rise"],
    answerIndex: 2,
  ...
  },
  {
    ...
    choices: ["Routine periodic maintenance costs", "Annual insurance premiums on the asset", "Wages paid to the equipment operators", "Freight and installation readying it for use"],
    answerIndex: 3,
