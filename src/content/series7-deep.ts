    ...
    sections: [
      ...
      },
      {
        ...
        blocks: [
          ...
          { kind: "figure", figure: { caption: "Figure 1 — Long call payoff. The loss is capped at the $400 premium while the stock sits at or below the strike; above the $54 breakeven (strike + premium) the profit is unlimited.", alt: "Payoff diagram of a long call: flat at minus $400 up to the strike, then rising through the breakeven into unlimited profit.", svg: `<svg viewBox="0 0 460 240" xmlns="http://www.w3.org/2000/svg" width="100%" style="max-width:460px"><rect x="52" y="22" width="390" height="123.5" fill="var(--ats-green-bg)"/><rect x="52" y="145.5" width="390" height="52.5" fill="var(--ats-red-bg)"/><line x1="52" y1="145.5" x2="442" y2="145.5" stroke="var(--text-muted)" stroke-width="1.2"/><line x1="52" y1="22" x2="52" y2="198" stroke="var(--border)" stroke-width="1"/><line x1="202.0" y1="22" x2="202.0" y2="198" stroke="var(--border)" stroke-width="1" stroke-dasharray="3 3"/><text x="202.0" y="211" text-anchor="middle" font-size="9.5" fill="var(--text-muted)">strike 50</text><circle cx="262.0" cy="145.5" r="3.2" fill="var(--primary)"/><text x="262.0" y="139.5" text-anchor="middle" font-size="9" font-weight="700" fill="var(--primary)">BE 54</text><path d="M 52.0 181.0 L 202.0 181.0 L 262.0 145.5 L 442.0 39.0" fill="none" stroke="var(--primary)" stroke-width="2.6" stroke-linejoin="round"/><text x="46" y="184.0" text-anchor="end" font-size="9" fill="var(--text-muted)">-$400</text><text x="46" y="148.5" text-anchor="end" font-size="9" fill="var(--text-muted)">0</text><text x="22" y="83.7" text-anchor="middle" font-size="9" fill="var(--ats-green)" transform="rotate(-90 22 83.7)">profit</text><text x="22" y="171.7" text-anchor="middle" font-size="9" fill="var(--ats-red)" transform="rotate(-90 22 171.7)">loss</text><text x="247.0" y="234" text-anchor="middle" font-size="9.5" fill="var(--text-muted)">stock price at expiration →</text><text x="52" y="14" font-size="11" font-weight="700" fill="var(--text-primary)">Long call — 50 strike, premium 4</text></svg>` } },
          { kind: "figure", figure: { caption: "Figure 2 — Long put payoff. The mirror image: profit grows as the stock falls (largest if it goes to zero), while the loss is capped at the $300 premium once the stock is at or above the $47 breakeven (strike − premium).", alt: "Payoff diagram of a long put: a declining line that flattens at minus $300 above the strike.", svg: `<svg viewBox="0 0 460 240" xmlns="http://www.w3.org/2000/svg" width="100%" style="max-width:460px"><rect x="52" y="22" width="390" height="132.4" fill="var(--ats-green-bg)"/><rect x="52" y="154.4" width="390" height="43.6" fill="var(--ats-red-bg)"/><line x1="52" y1="154.4" x2="442" y2="154.4" stroke="var(--text-muted)" stroke-width="1.2"/><line x1="52" y1="22" x2="52" y2="198" stroke="var(--border)" stroke-width="1"/><line x1="292.0" y1="22" x2="292.0" y2="198" stroke="var(--border)" stroke-width="1" stroke-dasharray="3 3"/><text x="292.0" y="211" text-anchor="middle" font-size="9.5" fill="var(--text-muted)">strike 50</text><circle cx="247.0" cy="154.4" r="3.2" fill="var(--primary)"/><text x="247.0" y="148.4" text-anchor="middle" font-size="9" font-weight="700" fill="var(--primary)">BE 47</text><path d="M 52.0 39.0 L 247.0 154.4 L 292.0 181.0 L 442.0 181.0" fill="none" stroke="var(--primary)" stroke-width="2.6" stroke-linejoin="round"/><text x="46" y="184.0" text-anchor="end" font-size="9" fill="var(--text-muted)">-$300</text><text x="46" y="157.4" text-anchor="end" font-size="9" fill="var(--text-muted)">0</text><text x="22" y="88.2" text-anchor="middle" font-size="9" fill="var(--ats-green)" transform="rotate(-90 22 88.2)">profit</text><text x="22" y="176.2" text-anchor="middle" font-size="9" fill="var(--ats-red)" transform="rotate(-90 22 176.2)">loss</text><text x="247.0" y="234" text-anchor="middle" font-size="9.5" fill="var(--text-muted)">stock price at expiration →</text><text x="52" y="14" font-size="11" font-weight="700" fill="var(--text-primary)">Long put — 50 strike, premium 3</text></svg>` } },
        ],
      },
      {
        ...
        blocks: [
          ...
          { kind: "figure", figure: { caption: "Figure 3 — Covered call payoff. Long stock plus a short call: the upside is capped at the $50 strike (max gain $400), the $2 premium pulls the breakeven down to $46, and the downside is the stock's own — cushioned, but not eliminated, by the premium.", alt: "Payoff diagram of a covered call: a rising line that caps flat at plus $400 above the strike.", svg: `<svg viewBox="0 0 460 240" xmlns="http://www.w3.org/2000/svg" width="100%" style="max-width:460px"><rect x="52" y="22" width="390" height="73.8" fill="var(--ats-green-bg)"/><rect x="52" y="95.8" width="390" height="102.2" fill="var(--ats-red-bg)"/><line x1="52" y1="95.8" x2="442" y2="95.8" stroke="var(--text-muted)" stroke-width="1.2"/><line x1="52" y1="22" x2="52" y2="198" stroke="var(--border)" stroke-width="1"/><line x1="247.0" y1="22" x2="247.0" y2="198" stroke="var(--border)" stroke-width="1" stroke-dasharray="3 3"/><text x="247.0" y="211" text-anchor="middle" font-size="9.5" fill="var(--text-muted)">strike 50</text><circle cx="169.0" cy="95.8" r="3.2" fill="var(--primary)"/><text x="169.0" y="89.8" text-anchor="middle" font-size="9" font-weight="700" fill="var(--primary)">BE 46</text><path d="M 52.0 181.0 L 169.0 95.8 L 247.0 39.0 L 442.0 39.0" fill="none" stroke="var(--primary)" stroke-width="2.6" stroke-linejoin="round"/><text x="46" y="42.0" text-anchor="end" font-size="9" fill="var(--text-muted)">+$400</text><text x="46" y="98.8" text-anchor="end" font-size="9" fill="var(--text-muted)">0</text><text x="46" y="184.0" text-anchor="end" font-size="9" fill="var(--text-muted)">-$600</text><text x="22" y="58.9" text-anchor="middle" font-size="9" fill="var(--ats-green)" transform="rotate(-90 22 58.9)">profit</text><text x="22" y="146.9" text-anchor="middle" font-size="9" fill="var(--ats-red)" transform="rotate(-90 22 146.9)">loss</text><text x="247.0" y="234" text-anchor="middle" font-size="9.5" fill="var(--text-muted)">stock price at expiration →</text><text x="52" y="14" font-size="11" font-weight="700" fill="var(--text-primary)">Covered call — stock 48, short 50 call @2</text></svg>` } },
        ],
      },
      {
        ...
        blocks: [
          ...
          { kind: "figure", figure: { caption: "Figure 4 — Long straddle payoff. The maximum loss — the $500 total premium — sits right at the strike; the position turns profitable only beyond either breakeven, $45 or $55. The distinctive V is the signature of a volatility bet.", alt: "Payoff diagram of a long straddle: a V-shape with the maximum loss at the strike and two breakevens on either side.", svg: `<svg viewBox="0 0 460 240" xmlns="http://www.w3.org/2000/svg" width="100%" style="max-width:460px"><rect x="52" y="22" width="390" height="99.8" fill="var(--ats-green-bg)"/><rect x="52" y="121.8" width="390" height="76.2" fill="var(--ats-red-bg)"/><line x1="52" y1="121.8" x2="442" y2="121.8" stroke="var(--text-muted)" stroke-width="1.2"/><line x1="52" y1="22" x2="52" y2="198" stroke="var(--border)" stroke-width="1"/><line x1="247.0" y1="22" x2="247.0" y2="198" stroke="var(--border)" stroke-width="1" stroke-dasharray="3 3"/><text x="247.0" y="211" text-anchor="middle" font-size="9.5" fill="var(--text-muted)">strike 50</text><circle cx="165.8" cy="121.8" r="3.2" fill="var(--primary)"/><text x="165.8" y="115.8" text-anchor="middle" font-size="9" font-weight="700" fill="var(--primary)">BE 45</text><circle cx="328.2" cy="121.8" r="3.2" fill="var(--primary)"/><text x="328.2" y="115.8" text-anchor="middle" font-size="9" font-weight="700" fill="var(--primary)">BE 55</text><path d="M 52.0 39.0 L 165.8 121.8 L 247.0 181.0 L 328.2 121.8 L 442.0 39.0" fill="none" stroke="var(--primary)" stroke-width="2.6" stroke-linejoin="round"/><text x="46" y="184.0" text-anchor="end" font-size="9" fill="var(--text-muted)">-$500</text><text x="46" y="124.8" text-anchor="end" font-size="9" fill="var(--text-muted)">0</text><text x="22" y="71.9" text-anchor="middle" font-size="9" fill="var(--ats-green)" transform="rotate(-90 22 71.9)">profit</text><text x="22" y="159.9" text-anchor="middle" font-size="9" fill="var(--ats-red)" transform="rotate(-90 22 159.9)">loss</text><text x="247.0" y="234" text-anchor="middle" font-size="9.5" fill="var(--text-muted)">stock price at expiration →</text><text x="52" y="14" font-size="11" font-weight="700" fill="var(--text-primary)">Long straddle — 50 strike, total premium 5</text></svg>` } },
    ...
    sections: [
      {
        ...
        blocks: [
          ...
          { kind: "figure", figure: { caption: "Figure 1 — Why a lower nominal yield can win. For a 32% investor, a muni's tax-free 4.0% is worth 5.88% on a taxable basis — above the corporate's 5.5%. The higher the tax bracket, the taller that middle bar grows.", alt: "Bar chart comparing a 4.0% muni yield, its 5.88% tax-equivalent yield, and a 5.5% corporate yield.", svg: `<svg viewBox="0 0 460 230" xmlns="http://www.w3.org/2000/svg" width="100%" style="max-width:460px"><line x1="40" y1="180" x2="420" y2="180" stroke="var(--text-muted)"/><rect x="60" y="98.4" width="90" height="81.6" rx="4" fill="var(--ats-green)"/><text x="105" y="92.4" text-anchor="middle" font-size="12" font-weight="800" fill="var(--ats-green)">4.0%</text><text x="105" y="196" text-anchor="middle" font-size="9" font-weight="700" fill="var(--text-primary)">Muni</text><text x="105" y="209" text-anchor="middle" font-size="8.5" fill="var(--text-muted)">stated yield (tax-free)</text><rect x="185" y="60.0" width="90" height="120.0" rx="4" fill="var(--ats-green)"/><text x="230" y="54.0" text-anchor="middle" font-size="12" font-weight="800" fill="var(--ats-green)">5.88%</text><text x="230" y="196" text-anchor="middle" font-size="9" font-weight="700" fill="var(--text-primary)">Muni TEY</text><text x="230" y="209" text-anchor="middle" font-size="8.5" fill="var(--text-muted)">= 4.0% ÷ (1−0.32)</text><rect x="310" y="67.8" width="90" height="112.2" rx="4" fill="var(--text-secondary)"/><text x="355" y="61.8" text-anchor="middle" font-size="12" font-weight="800" fill="var(--text-secondary)">5.5%</text><text x="355" y="196" text-anchor="middle" font-size="9" font-weight="700" fill="var(--text-primary)">Corporate</text><text x="355" y="209" text-anchor="middle" font-size="8.5" fill="var(--text-muted)">taxable yield</text><text x="40" y="28" font-size="11" font-weight="700" fill="var(--text-primary)">Tax-equivalent yield — 32% bracket</text><text x="40" y="224" font-size="9" fill="var(--text-muted)">The muni's 4% is worth 5.88% pretax — beating the 5.5% corporate.</text></svg>` } },
        ],
      },
      {
    ...
    sections: [
      {
        ...
        blocks: [
          ...
          { kind: "figure", figure: { caption: "Figure 1 — A long margin account is just LMV = Debit + Equity. At purchase, Reg T fixes equity at 50%. If the stock falls, the debit (the broker's loan) stays fixed while equity shrinks — a maintenance call hits once equity drops to 25% of market value.", alt: "Two stacked bars: at purchase, equity and debit are each $10,000; at the maintenance call, the debit is still $10,000 but equity has shrunk to $3,333.", svg: `<svg viewBox="0 0 460 240" xmlns="http://www.w3.org/2000/svg" width="100%" style="max-width:460px"><rect x="70" y="117.0" width="130" height="73.0" fill="var(--ats-red-bg)" stroke="var(--ats-red)" stroke-width="1"/><text x="135.0" y="156.5" text-anchor="middle" font-size="9" fill="var(--ats-red)">Debit $10,000</text><rect x="70" y="44.0" width="130" height="73.0" fill="var(--ats-green-bg)" stroke="var(--ats-green)" stroke-width="1"/><text x="135.0" y="83.5" text-anchor="middle" font-size="9" fill="var(--ats-green)">Equity $10,000</text><text x="135.0" y="38.0" text-anchor="middle" font-size="9" font-weight="700" fill="var(--text-primary)">LMV $20,000</text><text x="135.0" y="206" text-anchor="middle" font-size="9" font-weight="700" fill="var(--primary)">At purchase</text><text x="135.0" y="219" text-anchor="middle" font-size="8.5" fill="var(--text-muted)">Reg T 50% · equity 50%</text><rect x="270" y="117.0" width="130" height="73.0" fill="var(--ats-red-bg)" stroke="var(--ats-red)" stroke-width="1"/><text x="335.0" y="156.5" text-anchor="middle" font-size="9" fill="var(--ats-red)">Debit $10,000</text><rect x="270" y="92.7" width="130" height="24.3" fill="var(--ats-green-bg)" stroke="var(--ats-green)" stroke-width="1"/><text x="335.0" y="107.8" text-anchor="middle" font-size="9" fill="var(--ats-green)">Equity $3,333</text><text x="335.0" y="86.7" text-anchor="middle" font-size="9" font-weight="700" fill="var(--text-primary)">LMV $13,333</text><text x="335.0" y="206" text-anchor="middle" font-size="9" font-weight="700" fill="var(--primary)">At maintenance call</text><text x="335.0" y="219" text-anchor="middle" font-size="8.5" fill="var(--text-muted)">equity down to 25%</text><text x="70" y="30" font-size="11" font-weight="700" fill="var(--text-primary)">Long margin account: LMV = Debit + Equity</text></svg>` } },
        ],
      },
      {
    ...
    sections: [
      {
        ...
        blocks: [
          ...
          { kind: "figure", figure: { caption: "Figure 1 — The inverse price–yield relationship. As market yields rise, a bond's price falls below par (a discount); as yields fall, the price rises above par (a premium). Where the market yield equals the coupon, the bond trades at par.", alt: "A downward-sloping convex curve of bond price against market yield, with a par line and premium/discount regions labeled.", svg: `<svg viewBox="0 0 460 240" xmlns="http://www.w3.org/2000/svg" width="100%" style="max-width:460px"><line x1="56" y1="111.0" x2="440" y2="111.0" stroke="var(--border)" stroke-width="1" stroke-dasharray="4 3"/><text x="440" y="107.0" text-anchor="end" font-size="9" fill="var(--text-muted)">par $1,000</text><line x1="56" y1="26" x2="56" y2="196" stroke="var(--border)"/><line x1="56" y1="196" x2="440" y2="196" stroke="var(--text-muted)"/><path d="M 56.0 26.0 L 65.6 33.4 L 75.2 40.6 L 84.8 47.6 L 94.4 54.3 L 104.0 60.8 L 113.6 67.1 L 123.2 73.3 L 132.8 79.2 L 142.4 84.9 L 152.0 90.5 L 161.6 95.9 L 171.2 101.1 L 180.8 106.1 L 190.4 111.0 L 200.0 115.8 L 209.6 120.4 L 219.2 124.8 L 228.8 129.1 L 238.4 133.3 L 248.0 137.3 L 257.6 141.2 L 267.2 145.0 L 276.8 148.7 L 286.4 152.2 L 296.0 155.7 L 305.6 159.0 L 315.2 162.2 L 324.8 165.4 L 334.4 168.4 L 344.0 171.3 L 353.6 174.1 L 363.2 176.9 L 372.8 179.6 L 382.4 182.1 L 392.0 184.6 L 401.6 187.1 L 411.2 189.4 L 420.8 191.7 L 430.4 193.9 L 440.0 196.0" fill="none" stroke="var(--primary)" stroke-width="2.6"/><circle cx="190.4" cy="111.0" r="3.4" fill="var(--primary)"/><text x="190.4" y="125.0" text-anchor="middle" font-size="8.5" fill="var(--primary)">yield = coupon</text><text x="86" y="50" font-size="9.5" font-weight="700" fill="var(--ats-green)">PREMIUM (price &gt; par)</text><text x="426" y="186" text-anchor="end" font-size="9.5" font-weight="700" fill="var(--ats-red)">DISCOUNT (price &lt; par)</text><text x="248" y="234" text-anchor="middle" font-size="9.5" fill="var(--text-muted)">market yield →</text><text x="16" y="111" text-anchor="middle" font-size="9.5" fill="var(--text-muted)" transform="rotate(-90 16 111)">bond price</text><text x="56" y="16" font-size="11" font-weight="700" fill="var(--text-primary)">The inverse price–yield relationship</text></svg>` } },
        ],
      },
      {
    ...
    sections: [
      ...
      },
      {
        ...
        blocks: [
          ...
          { kind: "figure", figure: { caption: "Figure 1 — A mutual fund's public offering price is its NAV plus the sales charge. Here the $0.80 charge on a $10.00 POP is 8.0% — taken on the POP, not the NAV, and capped by FINRA at 8.5%. Reaching a breakpoint shrinks the top band.", alt: "A stacked bar: NAV of $9.20 plus a sales charge of $0.80 equals a public offering price of $10.00, an 8.0% sales charge.", svg: `<svg viewBox="0 0 460 235" xmlns="http://www.w3.org/2000/svg" width="100%" style="max-width:460px"><text x="40" y="26" font-size="11" font-weight="700" fill="var(--text-primary)">Mutual fund pricing: POP = NAV + sales charge</text><line x1="40" y1="196" x2="420" y2="196" stroke="var(--text-muted)"/><text x="210.0" y="70.0" text-anchor="middle" font-size="11" font-weight="800" fill="var(--text-primary)">POP $10.00</text><rect x="140" y="78.0" width="140" height="9.4" fill="var(--ats-amber)"/><text x="210.0" y="85.7" text-anchor="middle" font-size="8.5" fill="white" font-weight="700">Sales charge $0.80</text><rect x="140" y="87.4" width="140" height="108.6" fill="var(--ats-green-bg)" stroke="var(--ats-green)"/><text x="210.0" y="144.7" text-anchor="middle" font-size="10" fill="var(--ats-green)" font-weight="700">NAV $9.20</text><line x1="292" y1="78.0" x2="292" y2="196" stroke="var(--text-muted)"/><text x="298" y="133.0" font-size="9" fill="var(--text-primary)" font-weight="700">8.0% sales charge</text><text x="298" y="146.0" font-size="8.5" fill="var(--text-muted)">= $0.80 ÷ $10.00 POP</text><text x="298" y="159.0" font-size="8.5" fill="var(--text-muted)">(FINRA max 8.5%)</text></svg>` } },
        ],
      },
      {
    ...
    sections: [
      ...
      },
      {
        ...
        blocks: [
          ...
          { kind: "figure", figure: { caption: "Figure 1 — Where an IPO's money goes. The public offering price splits into the proceeds the issuer keeps and the underwriting spread. The spread itself divides into the manager's fee, the underwriting fee, and the selling concession — the largest slice, paid to whoever places the shares.", alt: "A horizontal bar of the public offering price split into proceeds to issuer and the underwriting spread, with the spread subdivided into manager's fee, underwriting fee, and selling concession.", svg: `<svg viewBox="0 0 460 210" xmlns="http://www.w3.org/2000/svg" width="100%" style="max-width:460px"><rect x="40.0" y="70" width="258.4" height="40" fill="var(--text-secondary)" opacity="0.9"/><text x="169.2" y="93.0" text-anchor="middle" font-size="8.5" fill="white" font-weight="700">Proceeds to issuer</text><rect x="298.4" y="70" width="22.8" height="40" fill="var(--primary)" opacity="0.9"/><text x="309.8" y="93.0" text-anchor="middle" font-size="8" fill="white" font-weight="700">Mgr</text><rect x="321.2" y="70" width="38.0" height="40" fill="var(--ats-amber)" opacity="0.9"/><text x="340.2" y="93.0" text-anchor="middle" font-size="8" fill="white" font-weight="700">U/W</text><rect x="359.2" y="70" width="60.8" height="40" fill="var(--ats-green)" opacity="0.9"/><text x="389.6" y="93.0" text-anchor="middle" font-size="8.5" fill="white" font-weight="700">Concession</text><line x1="298.4" y1="118" x2="420" y2="118" stroke="var(--text-muted)" stroke-width="1"/><line x1="298.4" y1="114" x2="298.4" y2="122" stroke="var(--text-muted)"/><line x1="420" y1="114" x2="420" y2="122" stroke="var(--text-muted)"/><text x="359.2" y="134.0" text-anchor="middle" font-size="9" font-weight="700" fill="var(--text-primary)">the underwriting SPREAD</text><line x1="40" y1="62" x2="420" y2="62" stroke="var(--text-muted)" stroke-width="1"/><text x="230.0" y="57.0" text-anchor="middle" font-size="9" font-weight="700" fill="var(--text-primary)">Public Offering Price (POP)</text><text x="40" y="30" font-size="11" font-weight="700" fill="var(--text-primary)">Where the money goes: the underwriting spread</text><text x="40" y="200" font-size="8.7" fill="var(--text-muted)">The selling concession is the largest slice — it pays the reps who place the shares.</text></svg>` } },
        ],
      },
      {
    ...
    sections: [
      {
        ...
        blocks: [
          ...
          { kind: "figure", figure: { caption: "Figure 1 — The yield curve plots yield against maturity. A normal, upward-sloping curve (longer maturities yield more) is typical of expansion; an inverted, downward-sloping curve — short rates above long rates — has historically been a recession warning.", alt: "Two yield curves: a green upward-sloping normal curve and a red dashed downward-sloping inverted curve, plotted against maturity.", svg: `<svg viewBox="0 0 460 240" xmlns="http://www.w3.org/2000/svg" width="100%" style="max-width:460px"><line x1="52" y1="30" x2="52" y2="196" stroke="var(--border)"/><line x1="52" y1="196" x2="438" y2="196" stroke="var(--text-muted)"/><path d="M 52.0 172.3 L 61.6 164.5 L 71.3 157.1 L 81.0 150.1 L 90.6 143.6 L 100.2 137.5 L 109.9 131.7 L 119.5 126.2 L 129.2 121.1 L 138.9 116.2 L 148.5 111.7 L 158.2 107.4 L 167.8 103.3 L 177.4 99.5 L 187.1 95.9 L 196.8 92.5 L 206.4 89.4 L 216.0 86.4 L 225.7 83.5 L 235.3 80.9 L 245.0 78.4 L 254.7 76.0 L 264.3 73.8 L 273.9 71.7 L 283.6 69.7 L 293.2 67.9 L 302.9 66.1 L 312.6 64.5 L 322.2 62.9 L 331.8 61.5 L 341.5 60.1 L 351.2 58.8 L 360.8 57.6 L 370.4 56.5 L 380.1 55.4 L 389.8 54.4 L 399.4 53.4 L 409.1 52.5 L 418.7 51.6 L 428.3 50.8 L 438.0 50.1" fill="none" stroke="var(--ats-green)" stroke-width="2.6"/><path d="M 52.0 37.9 L 61.6 39.6 L 71.3 41.3 L 81.0 42.9 L 90.6 44.6 L 100.2 46.3 L 109.9 48.0 L 119.5 49.7 L 129.2 51.3 L 138.9 53.0 L 148.5 54.7 L 158.2 56.4 L 167.8 58.1 L 177.4 59.7 L 187.1 61.4 L 196.8 63.1 L 206.4 64.8 L 216.0 66.5 L 225.7 68.1 L 235.3 69.8 L 245.0 71.5 L 254.7 73.2 L 264.3 74.9 L 273.9 76.5 L 283.6 78.2 L 293.2 79.9 L 302.9 81.6 L 312.6 83.3 L 322.2 84.9 L 331.8 86.6 L 341.5 88.3 L 351.2 90.0 L 360.8 91.7 L 370.4 93.3 L 380.1 95.0 L 389.8 96.7 L 399.4 98.4 L 409.1 100.1 L 418.7 101.7 L 428.3 103.4 L 438.0 105.1" fill="none" stroke="var(--ats-red)" stroke-width="2.6" stroke-dasharray="5 3"/><rect x="60" y="28" width="14" height="3" fill="var(--ats-green)"/><text x="78" y="32" font-size="9" fill="var(--text-primary)">Normal (upward) — expansion</text><rect x="60" y="42" width="14" height="3" fill="var(--ats-red)"/><text x="78" y="46" font-size="9" fill="var(--text-primary)">Inverted (downward) — recession signal</text><text x="245" y="234" text-anchor="middle" font-size="9.5" fill="var(--text-muted)">maturity  (short → long) →</text><text x="16" y="113" text-anchor="middle" font-size="9.5" fill="var(--text-muted)" transform="rotate(-90 16 113)">yield</text><text x="52" y="16" font-size="11" font-weight="700" fill="var(--text-primary)">The yield curve: normal vs inverted</text></svg>` } },
        ],
      },
      {
...
export const s7DeepQuestions: Question[] = [
  {
    ...
    choices: ["Bullish, with the right to buy", "Bearish, with an obligation to sell", "Bearish, with the right to sell", "Bullish, with an obligation to buy"],
    answerIndex: 0,
  ...
  },
  {
    ...
    choices: ["$400 max loss; breakeven $46", "Unlimited loss; breakeven $54", "$400 max loss; breakeven $54", "$4,000 max loss; breakeven $50"],
    answerIndex: 2,
  ...
  },
  {
    ...
    choices: ["$45 and $55", "$47 and $53", "$48 and $52", "$50 only"],
    answerIndex: 0,
  ...
  },
  {
    ...
    stem: "A customer in the 35% federal bracket is comparing a municipal bond yielding 3.5% with a corporate bond yielding 5.0%. Which is more attractive after tax, and why?",
    choices: ["The corporate bond, because its stated yield is the higher of the two", "They are equivalent once the federal tax treatment is applied", "The comparison cannot be made without knowing the state rate", "The municipal bond, whose taxable-equivalent yield is about 5.38%"],
    answerIndex: 3,
    explanation: "Taxable-equivalent yield divides the tax-free yield by one minus the marginal rate: 3.5% ÷ 0.65 ≈ 5.38%, which exceeds the corporate bond's 5.0%. Read the other direction, the corporate's after-tax yield is 5.0% × 0.65 = 3.25%, below the municipal's tax-free 3.5%. Comparing stated yields directly ignores that only one of the two is taxed, and while a state exemption would widen the gap further, the federal comparison already decides it.",
  },
  {
    id: "s7mun-d3", examSlug: "series-7", topicId: "munis", topicName: "Municipal Securities", difficulty: 2,
    stem: "Two municipal bonds are offered: one financing a toll bridge, one financing a county courthouse backed by property taxes. What distinguishes their credit analysis?",
    choices: ["The bridge bond turns on project revenues; the courthouse on taxing power", "Both are analyzed on the tax base, since municipalities issue each", "Both are analyzed on project feasibility, since each finances a facility", "The bridge bond carries a federal guarantee the courthouse lacks"],
    answerIndex: 0,
    explanation: "A revenue bond such as the toll bridge is repaid solely from the financed facility's receipts, so analysis centers on debt service coverage and the feasibility study. A general obligation bond such as the courthouse is backed by the issuer's full faith, credit, and taxing power, so analysis centers on the tax base, debt per capita, and assessed valuations. Neither carries any federal guarantee.",
  },
  {
    ...
    choices: ["Require voter approval and be subject to a debt limit", "Be repaid from project revenues, outside any debt limit", "Be backed by the issuer’s property tax receipts", "Carry lower credit risk in all cases"],
    answerIndex: 1,
  ...
  },
  {
    ...
    choices: ["Additional bonds test", "Flow of funds", "Rate covenant", "Feasibility study"],
    answerIndex: 2,
  ...
  },
  {
    ...
    stem: "A grandparent wants a tax-advantaged account to fund a grandchild's college expenses, retaining control of the assets. Which vehicle fits best?",
    choices: ["An UTMA custodial account naming the grandchild", "A Coverdell account funded to its annual maximum", "A joint tenancy account with right of survivorship", "A 529 plan with the grandparent as account owner"],
    answerIndex: 3,
    explanation: "A 529 plan lets the donor remain account owner, controlling distributions and retaining the ability to change beneficiaries, while earnings grow tax-deferred and qualified withdrawals are tax-free. An UTMA gift is irrevocable and passes to the minor outright at majority, which surrenders exactly the control the grandparent wants. Coverdell accounts carry far lower contribution limits, and joint tenancy offers no education tax advantage.",
  },
  ...
  },
  {
    ...
    choices: ["30% of the long market value", "50% of the long market value", "25% of the long market value", "$2,000"],
    answerIndex: 2,
  ...
  },
  {
    ...
    choices: ["$10,000", "$12,500", "$7,500", "$13,333"],
    answerIndex: 3,
  ...
  },
  {
    ...
    stem: "A customer buys 1,000 shares at $40 in a margin account under Reg T. The stock later falls to $30. What is the customer's equity, and is a maintenance call triggered?",
    choices: ["$30,000 equity; no call, since the position retains full value", "$10,000 equity; no call, since equity exceeds the $7,500 minimum", "$10,000 equity; a call is triggered because the stock declined", "$20,000 equity; no call, since the deposit is unchanged"],
    answerIndex: 1,
    explanation: "The purchase costs $40,000, Reg T requires a 50% deposit of $20,000, and the broker lends the remaining $20,000 as the debit balance. When the market value falls to $30,000, equity equals market value less the unchanged debit: $30,000 − $20,000 = $10,000. FINRA's 25% maintenance minimum on a $30,000 position is $7,500, so equity remains above it and no call is issued. A call would come only once market value fell to the debit divided by 0.75, or about $26.67 per share.",
  },

  {
    ...
    choices: ["Time or price of an order the customer specified", "Commission charged", "Asset, action, or amount of a trade", "Settlement date"],
    answerIndex: 2,
  ...
  },
  {
    ...
    choices: ["The deceased owner's estate", "The broker-dealer", "A court-appointed trustee", "The surviving owner(s)"],
    answerIndex: 3,
  ...
  },
  {
    ...
    choices: ["Act in the customer's best interest ahead of the firm's own", "Guarantee the customer a profit on the recommendation", "Recommend only the firm's proprietary products", "Avoid disclosing any fees associated with the account"],
    answerIndex: 0,
  ...
  },
  {
    ...
    choices: ["$3,000", "$10,000", "$5,000", "$50,000"],
    answerIndex: 1,
  ...
  },
  {
    ...
    choices: ["The custodian legally owns the account assets", "Two adults share survivorship rights", "A custodian manages assets owned by a minor", "A corporation holds the securities"],
    answerIndex: 2,
  ...
  },
  {
    ...
    choices: ["Reasonable-basis suitability", "Customer identification", "JTWROS rules", "Quantitative suitability (churning)"],
    answerIndex: 3,
...

  {
    ...
    choices: ["Fall", "Rise", "Stay the same", "Rise then fall"],
    answerIndex: 0,
  ...
  },
  {
    ...
    choices: ["YTC < YTM < current < nominal", "Current < nominal < YTC < YTM", "Nominal < current < YTM < YTC", "They are all equal"],
    answerIndex: 2,
  ...
  },
  {
    ...
    choices: ["Mortgage bond", "Equipment trust certificate", "Collateral trust bond", "Subordinated debenture"],
    answerIndex: 3,
  ...
  },
  {
    ...
    choices: ["25 shares", "10 shares", "40 shares", "400 shares"],
    answerIndex: 0,
...

  {
    ...
    choices: ["Trades on an exchange at a market price", "Issues a fixed number of shares at inception", "Continuously offers and redeems shares at NAV", "Can trade at a premium or discount to NAV"],
    answerIndex: 2,
  ...
  },
  {
    ...
    choices: ["Class A, with a front-end load and breakpoint discounts", "Class B (back-end load, high 12b-1)", "Class C, carrying a level ongoing load", "All share classes cost the investor the same"],
    answerIndex: 0,
  ...
  },
  {
    ...
    choices: ["Guarantees a fixed minimum rate of return to the holder", "Is not subject to securities regulation", "Imposes no surrender charges on early withdrawal", "Invests in a separate account, placing investment risk on the holder"],
    answerIndex: 3,
...

  {
    ...
    choices: ["Last, after creditors and preferred shareholders", "First, before all creditors", "After secured creditors but before bondholders", "At the same time as preferred shareholders"],
    answerIndex: 0,
  ...
  },
  {
    ...
    choices: ["A longer term and an exercise price above market", "No expiration", "A short term and a subscription price below market", "Voting rights"],
    answerIndex: 2,
  ...
  },
  {
    ...
    choices: ["On the ex-dividend date", "On the payment date", "On the record date", "Before the ex-dividend date"],
    answerIndex: 3,
  ...
  },
  {
    ...
    stem: "An investor wants income with priority over common shareholders but is willing to give up voting rights and unlimited upside. Which security fits best?",
    choices: ["Preferred stock, paying a fixed dividend ahead of common", "Common stock, which carries the greatest long-run appreciation", "A subscription right, priced below the current market", "A warrant attached to the issuer's bond offering"],
    answerIndex: 0,
    explanation: "Preferred stock pays a fixed stated dividend and ranks ahead of common for both dividends and liquidation proceeds, while typically carrying no vote and no participation in growth — precisely the trade the investor described. Common stock reverses every element of that trade. Rights and warrants are instruments for purchasing stock rather than income securities.",
  },
  {
    ...
    choices: ["Buy US Treasury bonds at a discount", "Hold foreign company shares trading in dollars on US markets", "Receive dividends guaranteed by the depositary bank", "Avoid currency risk on the underlying foreign shares"],
    answerIndex: 1,
...

  {
    ...
    stem: "A corporation is preparing to sell shares to the public for the first time. Which federal statute principally governs this transaction?",
    choices: ["The Securities Exchange Act of 1934, governing securities markets", "The Investment Company Act of 1940, governing pooled vehicles", "The Securities Act of 1933, governing new issues and disclosure", "The Trust Indenture Act of 1939, governing debt covenants"],
    answerIndex: 2,
    explanation: "The Securities Act of 1933 regulates the primary market, requiring registration and prospectus delivery so that buyers of new issues receive full disclosure. The 1934 Act created the SEC and governs secondary market trading, exchanges, and broker-dealers. The 1940 Act addresses investment companies and the Trust Indenture Act governs bond indentures — neither applies to a first-time equity offering.",
  },
  {
    ...
    choices: ["Acts only as an agent with no risk", "Guarantees the stock price will rise", "Is exempt from the registration requirement entirely", "Buys the entire issue and bears unsold-share risk"],
    answerIndex: 3,
  ...
  },
  {
    ...
    choices: ["Red herring", "Tombstone", "Final prospectus", "Registration statement"],
    answerIndex: 0,
  ...
  },
  {
    ...
    choices: ["Approves and endorses the security as a sound investment", "Has confirmed required disclosures were made, not endorsed it", "Guarantees the investment against loss of principal", "Sets the price at which the issue is offered"],
    answerIndex: 1,
  ...
  },
  {
    ...
    choices: ["The general public via a prospectus", "Only investors domiciled outside the country", "Government agencies and instrumentalities only", "Accredited investors, with no public offering"],
    answerIndex: 3,
...

  {
    ...
    stem: "A customer purchases a 52-week Treasury bill with a $10,000 face value for $9,700. How does the customer earn a return on this security?",
    choices: ["Through the $300 difference between purchase price and face value", "Through semiannual coupon payments totaling $300 over the year", "Through a principal adjustment tied to the Consumer Price Index", "Through a floating rate reset quarterly against a benchmark"],
    answerIndex: 0,
    explanation: "Treasury bills pay no coupon. They are issued at a discount to face value, and the investor's entire return is the $300 difference received at maturity. Semiannual coupons describe Treasury notes and bonds, principal indexing describes TIPS, and floating-rate resets describe Treasury FRNs — each a different instrument the exam expects candidates to separate.",
  },
  {
    ...
    choices: ["Exempt from federal tax but subject to state tax", "Federally taxable but exempt from state and local tax", "Exempt from taxation at every level of government", "Taxable only by local taxing authorities"],
    answerIndex: 1,
  ...
  },
  {
    ...
    choices: ["Fannie Mae (FNMA)", "Freddie Mac (FHLMC)", "None of them", "Ginnie Mae (GNMA)"],
    answerIndex: 3,
  ...
  },
  {
    ...
    choices: ["Prepayment risk when falling rates spur refinancing", "Default risk on the underlying Treasury obligations", "Currency risk on foreign-denominated holdings", "That it never returns principal"],
    answerIndex: 0,
  ...
  },
  {
    ...
    stem: "A customer wants a known lump sum at a child's college enrollment in twelve years and wishes to avoid reinvestment risk entirely. Which Treasury product fits best?",
    choices: ["Treasury notes paying semiannual coupons for twelve years", "Treasury STRIPS maturing in twelve years at face value", "Treasury bills rolled over every fifty-two weeks", "TIPS with principal adjusted for inflation each period"],
    answerIndex: 1,
    explanation: "STRIPS are zero-coupon Treasuries bought at a discount and maturing at face value, so there are no interim coupons to reinvest and the maturity amount is known at purchase — exactly what a dated funding need requires. Coupon-paying notes and rolled bills both create reinvestment risk, and TIPS deliver an inflation-adjusted rather than a predetermined nominal amount. Note that STRIPS holders owe annual tax on phantom accreted interest.",
  },

  {
    id: "s7dpp-d1", examSlug: "series-7", topicId: "dpp", topicName: "Direct Participation Programs", difficulty: 1,
    stem: "A direct participation program generates a $50,000 operating loss for the year. How is this loss treated for tax purposes?",
    choices: ["The partnership deducts it against entity-level taxable income", "It is carried forward until the partnership is finally dissolved", "It passes through to investors and may offset passive income", "It is deductible in full against each investor's wage income"],
    answerIndex: 2,
    explanation: "A DPP is a flow-through entity, so income and losses pass directly to investors rather than being taxed at the partnership level. Passive losses may generally offset passive income from other activities but not wages or portfolio income, which is the limitation that makes the pass-through less valuable than it first appears. Nothing is deferred to dissolution, since the flow-through happens annually.",
  },
  {
    id: "s7dpp-d2", examSlug: "series-7", topicId: "dpp", topicName: "Direct Participation Programs", difficulty: 2,
    stem: "A limited partnership faces creditor claims exceeding its assets. What is the exposure of the general partner compared with a limited partner?",
    choices: ["Both are limited to the amount each originally invested", "The limited partner bears unlimited liability as the passive investor", "Neither has exposure beyond the partnership's own assets", "The general partner has unlimited personal liability; the limited partner does not"],
    answerIndex: 3,
    explanation: "The general partner manages the program and accepts unlimited personal liability for partnership obligations, which is the price of control. Limited partners are passive investors whose exposure is capped at their invested capital, which is the entire reason the limited partnership form exists. Reversing the two roles is the most common exam trap on this topic.",
  },
  {
    ...
    choices: ["Passive income only", "Salary (earned income)", "Portfolio income such as dividends", "Any type of income"],
    answerIndex: 0,
  ...
  },
  {
    ...
    choices: ["The tax write-offs it generates", "The general partner's tax bracket", "Its economic viability as a business", "The size of the sales commission"],
    answerIndex: 2,
  ...
  },
  {
    ...
    choices: ["Traded actively on exchanges", "Redeemable daily at net asset value", "Guaranteed against loss by the SEC", "Illiquid, lacking an active secondary market"],
    answerIndex: 3,
...

  {
    ...
    choices: ["Debit spread that profits as the spread widens", "Credit spread that profits as the spread narrows", "Straddle", "Covered call"],
    answerIndex: 0,
  ...
  },
  {
    ...
    choices: ["$50.00", "$57.50", "$52.50", "$60.00"],
    answerIndex: 2,
  ...
  },
  {
    ...
    choices: ["Stay near the strike", "Rise steadily without falling", "Declare and pay a dividend", "Move sharply in either direction"],
    answerIndex: 3,
  ...
  },
  {
    ...
    choices: ["Buy a protective call against the position", "Buy a put on the same underlying", "Sell a call against the position", "Leave the position entirely unhedged"],
    answerIndex: 0,
  ...
  },
  {
    ...
    stem: "An investor expects a large price move in either direction but wants to pay less premium than a straddle would cost. Which position fits?",
    choices: ["A straddle, using the same at-the-money strike for both", "A strangle, using out-of-the-money strikes on both legs", "A covered call, collecting premium against stock held", "A bull call spread, capping both risk and potential reward"],
    answerIndex: 1,
    explanation: "A strangle buys a call and a put at different, typically out-of-the-money strikes, which costs less premium than a straddle but requires a larger move before either leg pays. A straddle uses the same strike and costs more. A covered call and a bull spread are directional or income positions rather than volatility bets, so neither expresses a view that the stock will move sharply either way.",
  },

  {
    ...
    choices: ["Changing reserve requirements", "Fiscal policy set by the elected branches", "Open market operations in Treasury securities", "Setting marginal income tax rates"],
    answerIndex: 2,
  ...
  },
  {
    ...
    choices: ["Rise", "Stay the same", "Become tax-free", "Fall"],
    answerIndex: 3,
  ...
  },
  {
    ...
    stem: "An economy reports declining real GDP in two consecutive quarters while unemployment continues to rise. This pattern is best described as:",
    choices: ["A recession, by the conventional definition", "An expansion nearing its cyclical peak", "A trough marking the start of recovery", "A period of stagflation with rising prices"],
    answerIndex: 0,
    explanation: "Two consecutive quarters of declining real GDP is the conventional shorthand for a recession, and rising unemployment is consistent since it lags the cycle. A peak marks the high point before decline rather than the decline itself, and a trough is the bottom that precedes recovery. Stagflation additionally requires persistent inflation, which the scenario does not describe.",
  },
  {
  ...
  },
  {
    ...
    choices: ["Technical analysis", "Open market operations", "Fundamental analysis", "The yield curve"],
    answerIndex: 2,
  ...
  },
  {
    ...
    stem: "Congress passes legislation raising income tax rates while the Federal Reserve simultaneously lowers the discount rate. These actions are:",
    choices: ["Expansionary fiscal policy alongside contractionary monetary policy", "Two contractionary measures whose effects will compound", "Two monetary measures pursued by different authorities", "Contractionary fiscal policy alongside expansionary monetary policy"],
    answerIndex: 3,
    explanation: "Taxing and spending are fiscal tools wielded by Congress, and raising taxes withdraws money from the private economy, making it contractionary. Interest rates are monetary tools wielded by the Federal Reserve, and lowering the discount rate is expansionary. The two therefore pull in opposite directions rather than compounding, and only one of them is monetary policy.",
  },

  {
    ...
    choices: ["Selling away", "Churning", "Front-running", "Painting the tape"],
    answerIndex: 0,
  ...
  },
  {
    ...
    choices: ["No review at all", "Only the customer's signature", "Principal approval before use", "SEC pre-clearance"],
    answerIndex: 2,
  ...
  },
  {
    ...
    choices: ["Code of Procedure", "Form U4 process", "Telemarketing rules", "Code of Arbitration"],
    answerIndex: 3,
  ...
  },
  {
    ...
    choices: ["At any hour of the day or night without restriction", "Between 8 a.m. and 9 p.m. in the called party's time zone", "Only on weekends and recognized public holidays", "Only after a sale has already been completed"],
    answerIndex: 1,
