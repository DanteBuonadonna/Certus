---
title: "CFA Level 1 Ethics Tips: How to Score High (2026)"
description: "CFA Level 1 ethics tips that actually work: why Ethics is the highest-weighted topic, how the ethics adjustment works, and the trap answers to stop falling for."
date: "2026-08-01"
...
**Weeks 1–2 (about 6 hours).** Read the Code and the seven Standards straight through. Don't take notes yet. Just get the map in your head. The [Standards of Practice Handbook, 12th edition](https://www.cfainstitute.org/sites/default/files/-/media/documents/code/code-ethics-standards/standards-practice-handbook-12th-edition.pdf) is free from CFA Institute — it's the actual source the exam is written from, and it's the best free CFA resource nobody uses.
...
If you want to see where you actually stand, take a [free full CFA mock exam](/free-cfa-mock-exam) — no signup — and look only at your Ethics section first. If you're under 70% there, that's the highest-return fix available to you, and it costs nothing but reading.
...
Certus is built around that idea — short, repeated practice on the stuff that moves your score, for less than the price of a textbook. See how it compares in our [cheapest CFA prep breakdown](/cheapest-cfa-prep), start with our [CFA Level 1 prep track](/cfa-level-1-prep), or go deeper with the [complete CFA Level 1 study guide](/blog/cfa-level-1-study-guide).

When you're ready to find out where you stand, [take the free mock exam](/free-cfa-mock-exam). It's the whole thing, it's free, and you don't need an account.
