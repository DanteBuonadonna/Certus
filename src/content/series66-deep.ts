...
export const s66DeepQuestions: Question[] = [
  {
    ...
    choices: ["Broker-dealer", "Agent", "Investment adviser representative", "Solicitor"],
    answerIndex: 0,
  ...
  },
  {
    ...
    choices: ["Immediately upon filing", "Noon on the 30th day after filing", "One full year after the filing date", "Only after an exam is passed"],
    answerIndex: 1,
  ...
  },
  {
    ...
    choices: ["The person is relieved of registration despite meeting the definition", "The security is fraudulent", "The person does not meet the statutory definition at all", "Registration is automatic"],
    answerIndex: 2,
  ...
  },
  {
    ...
    choices: ["Setting federal tax rates", "Approving the merit of every security as a good investment", "Guaranteeing investor returns", "Issuing cease-and-desist orders and conducting investigations"],
    answerIndex: 3,
  ...
  },
  {
    ...
    choices: ["Receive compensation", "Hold a license", "Work for a bank", "Manage over $1 billion"],
    answerIndex: 0,
  ...
  },
  {
    ...
    choices: ["The state only", "The SEC, as federal covered", "FINRA, as the industry SRO", "The MSRB, for municipal matters"],
    answerIndex: 1,
  ...
  },
  {
    ...
    choices: ["Speed and accuracy", "Disclosure and silence", "Care and loyalty", "Profit and growth"],
    answerIndex: 2,
  ...
  },
  {
    ...
    choices: ["Form U4", "A prospectus", "Form BD", "Form ADV Part 2"],
    answerIndex: 3,
  ...
  },
  {
    ...
    stem: "A client asks why two funds with identical standard deviations carry different betas. The correct explanation is that beta measures:",
    choices: ["Sensitivity to market movements, capturing only systematic risk", "Total variability of returns, including both risk components", "The proportion of return attributable to the manager's skill", "The consistency of returns relative to the risk-free rate"],
    answerIndex: 0,
    explanation: "Beta isolates systematic risk - how much the security moves with the market. Standard deviation measures TOTAL risk, both systematic and unsystematic, which is why two funds can share a standard deviation while differing sharply in beta: one carries more diversifiable, security-specific risk. Manager skill is alpha, and consistency relative to the risk-free rate points toward the Sharpe ratio.",
  },
  {
  ...
  },
  {
    ...
    stem: "An investor adds thirty uncorrelated securities to a concentrated portfolio. Which risk declines, and which remains?",
    choices: ["Systematic risk falls sharply; unsystematic risk remains unchanged", "Both decline proportionately as the number of holdings increases", "Unsystematic risk falls sharply; systematic market risk remains", "Neither declines, since total portfolio variance is fixed"],
    answerIndex: 2,
    explanation: "Diversification eliminates unsystematic risk - the company- and industry-specific component - because idiosyncratic surprises offset across many holdings. Systematic risk is the market-wide component that no amount of diversification removes, which is precisely why it is the only risk investors are compensated for bearing. Most of the diversification benefit is captured within the first twenty to thirty securities, with diminishing returns after.",
  },
  {
    ...
    choices: ["Zero risk at any return level", "Guaranteed returns regardless of risk", "The lowest possible return", "Highest expected return per level of risk"],
    answerIndex: 3,
  ...
  },
  {
    ...
    choices: ["All persons, including exempt ones", "Only persons registered in the state", "Only investment advisers", "Only broker-dealers"],
    answerIndex: 0,
  ...
  },
  {
    ...
    stem: "An adviser executes a trade in a client's account and later moves the position to a different client's account after seeing how it performed. This practice is:",
    choices: ["Permitted, provided the adviser documents the reason for the change", "Prohibited, since reallocating trades after the fact defrauds clients", "Permitted, since both parties are clients of the same adviser", "Prohibited only if the adviser profits personally from the reallocation"],
    answerIndex: 1,
    explanation: "Allocating trades after observing performance - cherry-picking - lets an adviser steer winners to favored accounts and losers elsewhere, and it is a fraudulent practice regardless of documentation or whether the adviser personally profits. Allocation must be determined by a fair, pre-established methodology before the outcome is known. Common client representation is what creates the conflict, not what cures it.",
  },
  {
    ...
    choices: ["A verbal request", "The Administrator's approval", "Prior written authorization", "No authorization needed"],
    answerIndex: 2,
  ...
  },
  {
    ...
    choices: ["Churning", "Front-running", "Arbitrage", "Commingling"],
    answerIndex: 3,
